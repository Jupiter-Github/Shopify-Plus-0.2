    ...
    <>
      <Navbar className="p-0" fixed="top" color="light">
        ...
        <div>
          ...
          <Popover
            isOpen={uiState.showPopover}
            placement="bottom"
            target="loginButton"
            trigger="legacy"
            toggle={() => toggleEle("showPopover")}
          >
            <PopoverBody className=" text-center">
              ...
              <Button color="primary" onClick={handlerLoginLogout}>
                {" "}
          ...
          {uiState.showModel && <LoginModal toggleShowModal={toggleEle} />}
        </div>
      </Navbar>
    </>
  );
